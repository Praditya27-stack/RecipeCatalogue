        ...
        get() {
            ...
            for (data in proteinBreakfast.indices) {
                val recipe = Recipes(
                    ...
                    ingredient = ingredientsBreakfast[data],
                    instruction = instructionsBreakfast[data],
        ...
        get() {
            ...
            for (data in proteinDessert.indices) {
                val recipe = Recipes(
                    ...
                    ingredient = ingredientsDessert[data],
                    instruction = instructionsDessert[data],
        ...
        get() {
            ...
            for (data in proteinVegetarian.indices) {
                val recipe = Recipes(
                    ...
                    ingredient = ingredientsVegetarian[data],
                    instruction = instructionsVegetarian[data],
